    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent1 = new Intent(GridLayout.this,SearchActivityGrid.class);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId())
                {
                    ...
                    case (R.id.contact):
                        drawerLayout.closeDrawers();
                        Intent intent2 = new Intent(GridLayout.this,SocialActivity.class);
                        startActivity(intent2);
                        //overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                        break;
                    case (R.id.about):
                        drawerLayout.closeDrawers();
                        Intent intent1 = new Intent(GridLayout.this,AboutActivity.class);
                        startActivity(intent1);
                        //overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                        break;
                    case (R.id.share):
                    ...
                    case (R.id.workshop):
                        drawerLayout.closeDrawers();
                        Intent intentWorkshop = new Intent(GridLayout.this,SearchActivityGrid.class);
                        intentWorkshop.putExtra("searchItem", "workshop");
                        startActivity(intentWorkshop);
                        break;
                    case (R.id.seminars):
                        drawerLayout.closeDrawers();
                        Intent intentSeminars = new Intent(GridLayout.this,SearchActivityGrid.class);
                        intentSeminars.putExtra("searchItem", "seminar");
                        startActivity(intentSeminars);
                        break;
                    case (R.id.competitions):
                        drawerLayout.closeDrawers();
                        Intent intentCompetitions = new Intent(GridLayout.this,SearchActivityGrid.class);
    ...
    public void getData()
    {
        ...
        postList.enqueue(new Callback<PostList>() {
            ...
            public void onFailure(Call<PostList> call, Throwable t) {
                Toast.makeText(GridLayout.this, "Error Occured", Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(GONE);
