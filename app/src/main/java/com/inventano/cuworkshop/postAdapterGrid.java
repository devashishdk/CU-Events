...
public class postAdapterGrid extends RecyclerView.Adapter<postAdapterGrid.PostViewHolder>{
    private Context context;
    private List<Item> items;
    postAdapterGrid(Context context, List<Item> item)
    {
    ...
    public PostViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.postviewgrid,parent,false);
