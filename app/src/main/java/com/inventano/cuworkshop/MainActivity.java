        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId())
                {
                    ...
                    case (R.id.contact):
                        drawerLayout.closeDrawers();
                        Intent intent2 = new Intent(MainActivity.this,SocialActivity.class);
                    ...
                    case (R.id.workshop):
                        drawerLayout.closeDrawers();
                        Intent intentWorkshop = new Intent(MainActivity.this,SearchActivity.class);
                        intentWorkshop.putExtra("searchItem","WORKSHOP");
                        startActivity(intentWorkshop);
                        break;
                    case (R.id.seminars):
                        drawerLayout.closeDrawers();
                        Intent intentSeminars = new Intent(MainActivity.this,SearchActivity.class);
                        intentSeminars.putExtra("searchItem", "seminar");
                        startActivity(intentSeminars);
                        break;
                    case (R.id.competitions):
                        drawerLayout.closeDrawers();
                        Intent intentCompetitions = new Intent(MainActivity.this,SearchActivity.class);
