        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId())
                {
                    ...
                    case (R.id.contact):
                        drawerLayout.closeDrawers();
                        Intent intent2 = new Intent(SearchActivity.this,SocialActivity.class);
                        startActivity(intent2);
                        //overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                        break;
                    case (R.id.about):
                        drawerLayout.closeDrawers();
                        Intent intent1 = new Intent(SearchActivity.this,AboutActivity.class);
                        startActivity(intent1);
                        //overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                        break;
                    case (R.id.share):
                    ...
                    case (R.id.workshop):
                        drawerLayout.closeDrawers();
                        Intent intentWorkshop = new Intent(SearchActivity.this,SearchActivity.class);
                        intentWorkshop.putExtra("searchItem", "workshop");
                        startActivity(intentWorkshop);
                        break;
                    case (R.id.seminars):
                        drawerLayout.closeDrawers();
                        Intent intentSeminars = new Intent(SearchActivity.this,SearchActivity.class);
                        intentSeminars.putExtra("searchItem", "seminar");
                        startActivity(intentSeminars);
                        break;
                    case (R.id.competitions):
                        drawerLayout.closeDrawers();
                        Intent intentCompetitions = new Intent(SearchActivity.this,SearchActivity.class);
        ...
        switch (item.getItemId()) {
            case (R.id.changeLayout):
                if(item.getTitle() == "Grid") {
                    drawerLayout.closeDrawers();
                    Intent intent = new Intent(SearchActivity.this,SearchActivityGrid.class);
